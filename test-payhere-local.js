...
async function createTestForm(hash, config) {
  ...
  const formData = {
    ...
    return_url: "https://765fb61e0f58.ngrok-free.app/api/payments/return", // Use ngrok URL for testing
...
async function runTests() {
  ...
  if (hash && config) {
    ...
    console.log('✅ Using ngrok URL for return/cancel URLs');
    ...
    console.log('\n⚠️ Note: The return/cancel URLs now use ngrok, so they will work from PayHere.');
    console.log('This allows for complete end-to-end testing of the payment flow.');
  } else {
