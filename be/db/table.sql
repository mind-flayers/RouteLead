...
-- Includes all 18 tables, enum definitions, triggers, and indexes
...
CREATE TABLE IF NOT EXISTS public.parcel_requests (
  ...
  parcel_photos JSONB NOT NULL DEFAULT '[]'::JSONB,
  created_at TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS public.withdrawals (
  ...
  status withdrawal_status_enum NOT NULL,
...
-- 17. delivery_tracking
CREATE TABLE IF NOT EXISTS public.delivery_tracking (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  bid_id UUID NOT NULL REFERENCES public.bids(id),
  driver_location_lat NUMERIC,
  driver_location_lng NUMERIC,
...
-- 19. critical indexes for performance
